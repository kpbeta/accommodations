...
publicRoutes.route('/verify/:verificationId', {name: 'verificationPage',
	action: function(params){
		require('../imports/ui/verificationPage.js');
		FlowLayout.render('mainContent', {main: 'verificationTemplate'});
	}
	});
